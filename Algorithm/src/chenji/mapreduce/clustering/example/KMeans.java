package chenji.mapreduce.clustering.example;
...
public class KMeans extends Configured implements Tool{
    ...
    public static boolean stopIteration(Configuration conf) throws IOException{
        ...
        Path pervCenterFile=new Path("centers");
        Path currentCenterFile=new Path("output/part-r-00000");
    ...
    public int run(String[] args) throws Exception {
      ...
      //质心文件每行的第一个数字是索引
        FileInputFormat.setInputPaths(job, "centers");
    ...
    public static void main(String[] args) throws Exception {
        ...
        //样本数据文件中每个样本不需要标记索引
        Path dataFile=new Path("testdata");
